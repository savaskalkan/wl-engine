...
const setIcon = (dirDst, iconsPath) => {
  ...
  console.log(`  to ${dirDst}/ios/MyNewAppName2/Images.xcassets/AppIcon.appiconset/`);
  fs.copySync(`${iconsPath}/ios/`, `${dirDst}/ios/MyNewAppName2/Images.xcassets/AppIcon.appiconset/`, { overwrite: true });
